...
var filtered = watchList.filter((obj) => (obj.Director) === "Christopher Nolan")
console.log(filtered);

var avrgrtn = filtered.map((obj) => Number(obj.imdbRating));
console.log(avrgrtn);

var averageRating = avrgrtn.reduce((a,b) => (a + b), 0) / avrgrtn.length;
console.log(averageRating);

// var averageRating = avrgrtn.reduce((sum, item) => Number(sum + item.imdbRating), 0);
// console.log(averageRating);